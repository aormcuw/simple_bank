...
func (m *MockStore) CreateEntries(arg0 context.Context, arg1 simplebank.CreateEntriesParams) (simplebank.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetUser(arg0 context.Context, arg1 string) (simplebank.User, error) {
	m.ctrl.T.Helper()
